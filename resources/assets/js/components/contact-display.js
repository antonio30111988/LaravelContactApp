		...
		return(
				...
				<div className="contact-item" id={this.props.id}>
					...
					<div className=" contact contact-additional">
						<p className=" contact contact-gender"><span className="contact-labels">Sex:</span>   
						<span className="contact-content">{this.props.contact.gender}</span>
						</p>
						<p className=" contact contact-nickname">
						<span className="contact-labels">Nickname:</span>  <span className="contact-content">{this.props.contact.nick_name}</span>
						</p>
					</div>
					
					<div className="do-edit-save">
				
					<button className="do-save btn btn-warning btn-sm  "><span className="glyphicon glyphicon-download"></span> to Vd Card </button>
